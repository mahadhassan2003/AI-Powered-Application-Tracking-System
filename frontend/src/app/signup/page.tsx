...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen w-full font-inter bg-white dark:bg-zinc-950">
      ...
      <div className="flex w-full flex-col justify-center px-8 sm:px-12 md:w-1/2 lg:px-24">
        <div className="mx-auto w-full max-w-sm">
          ...
          <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
            Join the elite applicant tracking system today.
          </p>
          ...
          <p className="mt-8 text-center text-sm text-zinc-500 dark:text-zinc-400">
            ...
            <button onClick={() => router.push('/login')} className="font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400 transition-colors">
              Sign in
            </button>
          </p>
          <p className="mt-4 text-center text-sm text-zinc-500 dark:text-zinc-400 pb-8">
            Looking to hire?{' '}
            <button onClick={() => router.push('/recruiter/signup')} className="font-semibold text-emerald-600 hover:text-emerald-500 dark:text-emerald-400 transition-colors">
              Join as a Recruiter
            </button>
          </p>
        </div>
      ...
      {/* Right Pane - Visuals (Consistent with Login) */}
      <div className="hidden md:flex md:w-1/2 items-center justify-center bg-zinc-50 dark:bg-zinc-900/50 p-12">
         <div className="relative h-full w-full max-w-2xl overflow-hidden rounded-3xl bg-gradient-to-tr from-indigo-800 to-blue-600 shadow-2xl">
            ...
            <div className="absolute inset-x-8 inset-y-16 flex flex-col gap-6 rounded-2xl bg-white/10 p-8 shadow-2xl backdrop-blur-md border border-white/10 transform -rotate-2 transition-transform hover:rotate-0 duration-700">
               <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-2">
                     <div className="h-3 w-40 rounded-full bg-white/80"></div>
                     <div className="h-2 w-24 rounded-full bg-white/40"></div>
                  </div>
               </div>
               <div className="flex flex-col gap-3 mt-6">
                  <div className="h-16 rounded-xl bg-white/10 border border-white/5 w-full"></div>
                  <div className="h-16 rounded-xl bg-white/10 border border-white/5 w-[90%]"></div>
                  <div className="h-16 rounded-xl bg-white/10 border border-white/5 w-[95%]"></div>
               </div>
               <div className="h-24 rounded-xl bg-white/20 border border-white/10 mt-auto"></div>
            </div>
            
            {/* Overlay Text */}
            <div className="absolute bottom-12 left-12 right-12 z-10">
               <h2 className="text-3xl font-bold text-white mb-2">Advance your career.</h2>
               <p className="text-white/80 text-lg font-medium leading-relaxed">
                 Join thousands of candidates finding their perfect role using our AI matching technology.
               </p>
            </div>
         </div>
      </div>
